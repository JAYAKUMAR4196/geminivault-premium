  ...
  head: () => ({
    meta: [
      ...
      { title: "GeminiVault — Your thoughts. Your AI. Your privacy." },
      {
        name: "description",
        content:
          "GeminiVault is an end-to-end encrypted journal with a private Gemini intelligence layer that reflects on your writing without ever reading it in the clear.",
      },
      { name: "author", content: "GeminiVault" },
      { property: "og:title", content: "GeminiVault — Your thoughts. Your AI. Your privacy." },
      {
        property: "og:description",
        content: "An encrypted journal with a private AI reflection layer.",
      },
